...
const s = {
  ...
  pill:            { minWidth:28, height:28, borderRadius:'50%', background:'rgba(255,255,255,0.7)', color:'#94a3b8',
                     ...
                     fontWeight:700, flexShrink:0, cursor:'pointer', border:'1px solid rgba(255,255,255,0.9)' },
  ...
  testHint:        { textAlign:'center', padding:'50px 20px', fontSize:18,
                     color:'#15803d', fontWeight:700, lineHeight:1.8 },
  navRow:          { position:'fixed', bottom:0, left:0, right:0, display:'flex', gap:8,
                     padding:'12px 16px', background:'rgba(240,244,255,0.85)', backdropFilter:'blur(12px)', WebkitBackdropFilter:'blur(12px)', borderTop:'1.5px solid rgba(255,255,255,0.9)' },
...
const a = {
  ...
  tipBox:       { background:'rgba(219,234,254,0.5)', backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)', border:'1.5px solid rgba(147,197,253,0.4)', borderRadius:14, padding:14, marginTop:16,
                  fontSize:14, color:'#0D47A1', lineHeight:1.6 },
  noteBox:      { background:'rgba(254,243,199,0.6)', backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)', border:'1.5px solid rgba(253,224,71,0.3)', borderRadius:14, padding:14, marginTop:12,
  ...
  charCard:     { background:'rgba(255,255,255,0.65)', backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)', border:'1.5px solid',
  ...
  syllableBox:  { background:'rgba(219,234,254,0.8)', border:'2px solid rgba(59,130,246,0.5)',
  ...
  syllableRow:  { display:'flex', alignItems:'center', gap:12,
                  background:'rgba(255,255,255,0.65)', backdropFilter:'blur(8px)', WebkitBackdropFilter:'blur(8px)', border:'1px solid rgba(255,255,255,0.9)', borderRadius:12, padding:'10px 14px' },
  ...
  batchimCard:  { background:'rgba(254,249,195,0.6)', backdropFilter:'blur(6px)', WebkitBackdropFilter:'blur(6px)', border:'1.5px solid rgba(253,224,71,0.3)',
